...
<body class="preload dropdown-page">
                ...
                <div class="col-md-12">
                    <div class="shortcode_modules">
                        <div class="modules__title">
                            <h3>Dropdown با نگه داشتن اشاره گر </h3>
                        </div>
                                ...
                                <div class="col-lg-8 offset-lg-2">
                                    <div class="inline">
                                        <div class="has_dropdown">
                                            <button class="btn btn--light btn--bordered btn-md">Dropdown 1</button>
                                            <div class="dropdowns dropdown--author">
                                                <ul>
                                                    <li>
                                                        <a href="author.html">
                                    ...
                                    <div class="inline pull-right">
                                        <div class="has_dropdown">
                                            <button class="btn btn--light btn--bordered btn-md">Dropdown 2</button>
                                            <div class="dropdowns dropdown--menu">
                                                <ul>
                                                    <li>
                                                        <a href="all-products.html">موارد اخیر</a>
                                                    </li>
                                                    <li>
                                                        <a href="all-products.html">موارد محبوب</a>
                                                    </li>
                                                    <li>
                                                        <a href="index3.html">قالب رایگان </a>
                                                    </li>
