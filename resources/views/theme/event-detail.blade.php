...
<body class="preload carrier-page">
    ...
    <!--================================
        START JOB HERO AREA
    =================================-->
    <section class="job_hero_area event_detail_breadcrumb bgimage dir-rtl" >
        <div class="bg_image_holder">
            <img src="images/new/ev_bg.jpg" alt="">
        </div>
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="job_hero_content">
                        <h1>رویداد آینده ما د تهران </h1>
                        <div class="job_date">
                            <p>
                                <span class="lnr lnr-map-marker"></span>27 اردیبهشت 98</p>
                            <p>
                                <span class="lnr lnr-calendar-full"></span> ایران ، تهران</p>
                        </div>
                    </div>
                    <!-- end /.job_hero_content -->

                    <a href="#" class="btn btn--round btn--lg">ثبت نام در دوره </a>
    ...
    =================================-->
    <section class="event_details section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="event_module">
                        <h4 class="event_module__title">مرور کلی رویداد</h4>
                    ...
                    <div class="event_module">
                        <h4 class="event_module__title">سخنران های این جلسه </h4>

                        <div>
                            <div class="single_speaker">
                                <div class="speaker__thumbnail">
                                    <img src="images/new/speaker1.jpg" alt="">
                                </div>

                                <div class="speaker__detail">
                                    <h4>دامن دریا </h4>
                                    <span class="ocuup">توسعهدهنده وب</span>
                            ...
                            <div class="single_speaker">
                                <div class="speaker__thumbnail">
                                    <img src="images/new/speaker2.jpg" alt="">
                                </div>

                                <div class="speaker__detail">
                                    <h4>علی علوی</h4>
                                    <span class="ocuup">بازاریابی دیجیتال</span>
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.
                                    </p>
                    ...
                    <div class="event_module sponsor--area " dir="ltr">
                        <h4 class="event_module__title">حامیان رویداد
                             
                        </h4>

                        <ul class="sponsores">
                            <li>
                                <img src="images/new/spn1.jpg" alt="Sponsors image">
                            </li>
                            <li>
                                <img src="images/new/sp2.jpg" alt="Sponsors image">
                            </li>
                            <li>
                                <img src="images/new/sp3.jpg" alt="Sponsors image">
                            </li>
                            <li>
                                <img src="images/new/spn1.jpg" alt="Sponsors image">
                            </li>
        ...
        <div class="google_map dir-rtl">
            <div class="location_address">
                <div class="addres_module">
                    <h4>تهران ، برج میلاد </h4>
                    <p>
                        <span class="lnr lnr-phone-handset float-left"></span>  98 901-32-34-324 + </p>
                    <p>
                        <span class="lnr lnr-envelope float-left"></span>amir.d79@yahoo.com</p>
                </div>
            </div>
        ...
        <div class="sign_up_area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h2 class="sign_up_title">ثبت نام و در یافت بلیط</h2>
                        <div class="ticket_form">
                            <form action="#">
                                ...
                                <textarea cols="30" rows="10" placeholder="متن خود را بنویسید "></textarea>

                                <div class="sub_btn">
                                    <button type="button" class="btn btn--round btn--default">ثبت اطلاعات </button>
                                </div>
                            </form>
                        ...
                        <div class="info-footer">
                            ...
                            <ul class="info-contact">
                                <li>
                                    ...
                                    <span class="info">تلفن :91333333333</span>
                                </li>
                                <li>
                                    <span class="lnr lnr-envelope info-icon"></span>
                                    <span class="info dir-rtl">test@yahoo.com</span>
                                </li>
                                <li>
                                    <span class="lnr lnr-map-marker info-icon"></span>
                                    <span class="info">ایران ،ایران،ایران </span>
                                </li>
                            </ul>
                        </div>
                        <!-- end /.info-footer -->
