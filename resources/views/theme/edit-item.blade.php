                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form action="#">
                            <div class="upload_modules">
                                ...
                                <div class="information__set toggle_module collapse show" id="collapse2">
                                    <div class="modules__content">
                                        <div class="form-group">
                                            ...
                                            <div class="select-wrap select-wrap2">
                                                <select name="country" id="category" class="text_field">
                                                    ...
                                                    <option value="wordpress" selected>ورد پرس </option>
                                        ...
                                        <div class="form-group">
                                            <label for="product_name">نام
                                                <span>(حد اکثر  100کاراکتر)</span>
                                            </label>
                                            <input type="text" id="product_name" class="text_field" value="">
                                        </div>

                                        <div class="form-group no-margin">
                                            <p class="label">توضیع محصول </p>
                                    ...
                                    <div class="modules__content">
                                        <div class="form-group">
                                            <div class="upload_wrapper">
                                                <p>آپلود تصویر کوچک
                                                    <span>(JPEG یا  PNG 100x100px)</span>
                                                </p>
                                                ...
                                                <div class="upload_progress">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%;">
                                                            <span class="sr-only">90% انجام شده </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end /.upload_progress -->
                            ...
                            <div class="upload_modules">
                                <a class="toggle_title" href="#collapse5" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse5">
                                    <h4>قیمت  مجوز ها
                                        <span class="lnr lnr-chevron-down"></span>
                                    </h4>
                                </a>
