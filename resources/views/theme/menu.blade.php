...
<body class="preload menu-page">
    ...
    <section class="menus section--padding">
        ...
        <div class="shortcode_wrapper">
            ...
            <!-- start menu-area -->
            <div class="menu-area dir-rtl menu--style2 ">
                <!-- start .top-menu-area -->
                <div class="top-menu-area">
                    <!-- start .container -->
                    <div class="container">
        ...
        <div class="shortcode_wrapper">
            ...
            <!-- start menu-area -->
            <div class="menu-area menu--style1 dir-rtl">
                <!-- start .top-menu-area -->
                <div class="top-menu-area">
                    <!-- start .container -->
                    <div class="container">
                            ...
                            <div class="col-lg-8 offset-lg-1 col-6 col-md-9 v_middle">
                                ...
                                <div class="author-area not_logged_in">
                                    ...
                                    <div class="pull-right join">
                                        <a href="#" class="btn btn--round btn-secondary  btn--xs">ثبت نام </a>
                                        <a href="#" class="btn btn--round btn--xs">ورود </a>
                                    </div>
                                </div>
                                <!-- end .author-area -->
        ...
        <div class="shortcode_wrapper">
            ...
            <!-- start menu-area -->
            <div class="menu-area menu--style2 dir-rtl">
                <!-- start .top-menu-area -->
                <div class="top-menu-area">
                    <!-- start .container -->
                    <div class="container">
        ...
        <div class="shortcode_wrapper">
            ...
            <!-- start menu-area -->
            <div class="menu-area menu--style3 dir-rtl">
                <!-- start .top-menu-area -->
                <div class="top-menu-area">
                    <!-- start .container -->
                    <div class="container">
