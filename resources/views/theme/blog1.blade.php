                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="#">وبلاگ نسخه 1</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">وبلاگ نسخه 1</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
            ...
            <div class="row" data-uk-grid>
                <div class="col-lg-4 col-md-6">
                    <div class="single_blog blog--card">
                        <figure>
                            <img src="images/new/blog1.jpg" alt="Blog image">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_blog blog--card">
                        <figure>
                            <img src="images/new/blog2.jpg" alt="Blog image">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_blog blog--card">
                        <figure>
                            <img src="images/new/blog3.jpg" alt="Blog image">
