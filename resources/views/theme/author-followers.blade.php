...
<head>
    ...
    <title>دریا -دنبال کنندگان</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">دنبال کنندگان </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                    ...
                    <aside class="sidebar sidebar_author">
                        ...
                        <div class="sidebar-card author-menu">
                            <ul>
                                ...
                                <li>
                                    <a href="author-followers.html" class="active">دنبال کنندگان (67)</a>
                                </li>
                                <li>
                        ...
                        <div class="col-md-12">
                            <div class="product-title-area">
                                <div class="product__title">
                                    <h2>
                                        <span class="bold">67</span> دنبال کننده </h2>
                                </div>
                            </div>
                                        ...
                                        <div class="user_single">
                                            <div class="user__short_desc">
                                                <div class="user_avatar">
                                                    <img src="images/new/m1.png" alt="">
                                                </div>
                                                <div class="user_info">
                                                    <a href="#">تست</a>
                                                    <p>عضو شده از: 7  اردیبهشت 98 ایران</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="user__status user--following">
                                                <a href="#" class="btn btn--round btn--md">دنبال کردن </a>
                                            </div>
                                        </div>
                                        <!-- end /.user_single -->
                                    </li>
