    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="page-title">دنبال کردن </h1>
            </div>
            <!-- end /.col-md-12 -->
        </div>
        <!-- end /.row -->
                ...
                <aside class="sidebar sidebar_author">
                    ...
                    <div class="sidebar-card author-menu">
                        <ul>
                            ...
                            <li>
                                <a href="author-following.html" class="active">دنبال کردن (39)</a>
                            </li>
                        </ul>
                    </div>
                    <!-- end /.author-menu -->
                    ...
                    <div class="col-md-12">
                        <div class="product-title-area">
                            <div class="product__title">
                                <h2>
                                    <span class="bold">67</span> دنبال کردن  </h2>
                            </div>
                        </div>
