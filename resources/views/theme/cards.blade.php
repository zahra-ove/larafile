        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">کارت ها </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="card_style1">
                            <figure class="card_style1__info">
                                <img src="images/new/ev2.jpg" alt="Event card thumbnail">

                                <figcaption>
                                    <a href="event-detail.html">
                                        <h3>کنفرانس طراحی وب </h3>
                                    </a>
                                    <ul class="date_place">
                                        <li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card_style1">
                            <figure class="card_style1__info">
                                <img src="images/new/ev3.jpg" alt="Event card thumbnail">

                                <figcaption>
                                    <a href="event-detail.html">
                                        <h3>کنوانسیون فناوری در ملبورن</h3>
                                    </a>
                                    <ul class="date_place">
                                        <li>
                                            <span class="lnr lnr-calendar-full"></span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card_style1">
                            <figure class="card_style1__info">
                                <img src="images/new/ev4.jpg" alt="Event card thumbnail">

                                <figcaption>
                                    <a href="event-detail.html">
                                        <h3>معرفی شرکت سمینار وب</h3>
                                    </a>
                                    <ul class="date_place">
                                        <li>
                                            <span class="lnr lnr-calendar-full"></span>
