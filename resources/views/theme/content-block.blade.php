...
<body class="preload content-block-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">بلوک محتوا </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 v_middle">
                        <div class="area_image">
                            <img src="images/new/1.png" alt="area images">
                        </div>
                    </div>
                    <!-- end /.col-md-12 -->
                    ...
                    <div class="col-lg-5 col-md-6 offset-lg-2 v_middle">
                        <div class="area_content">
                            <h2>ایجاد یک حساب رایگان</h2>
                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
                            <a href="#" class="btn btn--default btn--white btn--round">ثبت نام </a>
                        </div>
                    </div>
                    <!-- end /.col-md-12 -->
                </div>
        ...
        <div class="content_block3 bgcolor">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6 v_middle">
                        <div class="area_content">
                            <h2>آپلود محصولات خود  
                            </h2>
                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.  </p>
                            <a href="#" class="btn btn--white btn--default btn--round">ثبت نام </a>
                        </div>
                    </div>
                    <!-- end /.col-md-12 -->
                    ...
                    <div class="col-lg-5 col-md-6 v_middle offset-lg-2">
                        <div class="area_image">
                            <img src="images/new/2.png" alt="area images">
                        </div>
                    </div>
                    <!-- end /.col-md-12 -->
                </div>
