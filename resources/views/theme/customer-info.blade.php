...
<head>
    ...
    <title>دریا  - اطلاعات حساب کاربری
    </title>
...
<body class="preload customer-info">
                                ...
                                <div class="information__set toggle_module">
                                    <div class="information_wrapper form--fields">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="fname" class="text_field" placeholder="نام" value="">
                                        </div>

                                        <div class="form-group">
                                            <label for="lname">نام خانوادگی</label>
                                            <input type="text" id="lname" class="text_field" placeholder="دامن دریا" value="">
                                        </div>

                                        <div class="form-group">
                                            <label for="dname">نام نمایش </label>
                                            <input type="text" id="dname" class="text_field" placeholder="" value="">
                                        </div>

                                        <div class="form-group">
                                            <label for="emailad">ایمیل</label>
                                            <input type="text" id="emailad" class="text_field" placeholder="amir.d79@yahoo.com" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="information_wrapper form--fields">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="city" id="city" class="text_field">
                                                ...
                                                <option selected="selected" value="1">یزد</option>
                                            </select>
                                        </div>
