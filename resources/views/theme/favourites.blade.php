                ...
                <div class="filter-bar">
                    ...
                    <div class="filter__option filter--layout ">
                        <a href="all-products.html">
                            <div class="svg-icon">
                                <img class="svg" src="images/new/svg/grid.svg" alt="it's just a layout control folks!">
                            </div>
                        </a>
                        <a href="all-products-list.html">
                            <div class="svg-icon">
                                <img class="svg" src="images/new/svg/list.svg" alt="it's just a layout control folks!">
                            </div>
                        </a>
                    </div>
                    <!-- end /.filter__option -->
