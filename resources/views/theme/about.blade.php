...
=================================-->
    <section class="about_hero bgimage dir-rtl">
        <div class="bg_image_holder">
            <img src="images/new/about_hero.jpg" alt="">
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="about_hero_contents">
                        <h1></h1>
                        <p>با ما به راهتی محصولات خود را بفروشید و  کسب درآمد کنید

                        </p>

                        <div class="about_hero_btns">
                            <a href="#" class="play_btn" data-toggle="modal" data-target="#myModal">
                                <img src="images/new/play_btn.png" alt="PLay">پخش ویدئو</a>
                            <a href="#" class="btn btn--white btn--lg btn--round">به ما بپیوندید</a>
                        </div>
                    </div>
...
=================================-->
    ...
    END ABOUT HERO AREA
=================================-->
    <section class="about_mission dir-rtl">
        <div class="content_block1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="content_area">
                            <h1 class="content_area--title">درباره
                                <span class="highlight">ما </span>
                            </h1>
            ...
            <div class="content_image bgimage">
                <div class="bg_image_holder">
                    <img src="images/new/ab1.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- end /.about -->
        ...
        <div class="content_block2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6 offset-md-6 offset-lg-7">
                        <div class="content_area2 text-justify">
                            <h1 class="content_area2--title">
                                <span class="highlight">ماموریت </span>
                                ما
                            </h1>
            ...
            <div class="content_image2 bgimage">
                <div class="bg_image_holder">
                    <img src="images/new/ab2.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- end /.mission-->
...
=================================-->
    ...
    START TIMELINE AREA
=================================-->
    <section class="timeline_area section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ul class="timeline">
                            <li class="happening">
                                ...
                                <div class="happening--detail">
                                    <h4 class="title">قالب فروشگاهی ورد پرس</h4>
...
=================================-->
    <section class="counter-up-area counter-up--area2 dir-rtl">
        <!-- start .container -->
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2>امروز ما اینجا هستیم
                         
                    </h2>
                </div>
            </div>
...
=================================-->
    <section class="team_area section--padding dir-rtl">
        <div class="container">
            <!-- start row -->
            <div class="row">
                <!-- start col-md-12 -->
                <div class="col-md-12">
                    <div class="section-title">
                        <h1>تیم                            <span class="highlighted">ما</span>
                        </h1>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="single_team_member">
                        <figure>
                            <img src="images/new/team1.jpg" alt="Team Member">
                            <figcaption>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="single_team_member">
                        <figure>
                            <img src="images/new/team2.jpg" alt="Team Member">
                            <figcaption>
                                <div class="name_desig">
                                    <h4>مریم مریمی</h4>
                                    <p>توسعه دهنده برنامه</p>
                                </div>
                                <!-- end /.name_desig -->
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="single_team_member">
                        <figure>
                            <img src="images/new/team3.jpg" alt="Team Member">
                            <figcaption>
                                <div class="name_desig">
                                    <h4>علی علوی</h4>
                                    <p>Js توسعهدهنده</p>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="single_team_member">
                        <figure>
                            <img src="images/new/team4.jpg" alt="Team Member">
                            <figcaption>
                                <div class="name_desig">
                                    <h4>دامن دریا </h4>
                                    <p>توسعه دهنده وب</p>
                ...
                <!-- end /.col-md-3 -->  <div class="col-lg-3 col-md-4">
                <div class="single_team_member">
                    <figure>
                        <img src="images/new/team1.jpg" alt="Team Member">
                        <figcaption>
...
=================================-->
    ...
    START PARTNER AREA
=================================-->
    <section class="partner-area section--padding partner--area2 bgimage dir-rtl">
        <div class="bg_image_holder">
            <img src="images/new/fn.jpg" alt="">
        </div>
        <!-- start container -->
        <div class="container">
            <!-- start row -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="section-title">
                        <h1>نظرات
                            <span class="highlighted">کاربران </span>
                        </h1>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                    </div>
                </div>
...
=================================-->
    ...
    START IMAGE GALLERY
=================================-->
    <section class="gallery_area dir-rtl">
        <div class="gallery_contents_wrapper bgimage">
            <div class="bg_image_holder">
                <img src="images/new/galbg.jpg" alt="">
            </div>
            <div class="container content_above">
                <div class="row">
