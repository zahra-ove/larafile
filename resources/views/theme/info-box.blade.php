...
<body class="preload info-box-page">
            ...
            <div class="col-md-12">
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li class="active">
                            <a href="#">جعبه اطلاعات </a>
                        </li>
                    </ul>
                </div>
                <h1 class="page-title">جعبه اطلاعات </h1>
            </div>
            <!-- end /.col-md-12 -->
        </div>
        <!-- end /.row -->
...
<section class="bgcolor section--padding dir-rtl">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="author-info author-info--dashboard mcolorbg1">
                        <p>فروش مادام العمر</p>
                        <h3>  5000،000 تومان</h3>
                    </div>
                </div>
                <!-- end /.col-md-3 -->
            </div>
    ...
    <div class="">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="shortcode_module_title">  <div class="dashboard__title">
                        <h3>طرح 2</h3>
                    </div></div>
