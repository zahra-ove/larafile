...
<head>
    ...
    <title>دریا  - داشبورد طراح </title>



    <!-- DATE_PLUGIN-->
    <link href='css/date_plugin/css/normalize.css' rel='stylesheet' />
    <link href='css/date_plugin/css/fontawesome/css/font-awesome.min.css' rel='stylesheet' />
    <link href="css/date_plugin/css/vertical-responsive-menu.min.css" rel="stylesheet" />
    <link href="css/date_plugin/css/style.css" rel="stylesheet" />
    <link href="css/date_plugin/css/prism.css" rel="stylesheet" />
    <link rel="stylesheet" href="css/date_plugin/css/persianDatepicker-default.css" />
    <link rel="stylesheet" href="css/date_plugin/css/persianDatepicker-dark.css" />
    <link rel="stylesheet" href="css/date_plugin/css/persianDatepicker-latoja.css" />
    <link rel="stylesheet" href="css/date_plugin/css/persianDatepicker-melon.css" />
    <link rel="stylesheet" href="css/date_plugin/css/persianDatepicker-lightorang.css" />
    <script src="js/date_plugin/js/prism.js"></script>
    <script src="js/date_plugin/js/vertical-responsive-menu.min.js"></script>
                ...
                <div class="col-md-12">
                    <div class="dashboard_title_area">
                        <div class="dashboard__title">
                            <h3>بیانیه های فروش</h3>
                            <div class="date_area">
                                <form action="#">
                                    <div class="input_with_icon">

                                        <input type="text" class="dattaPikkara" placeholder="از تاریخ">
                                        <span class="lnr lnr-calendar-full"></span>
                                    </div>

                                    <div class="input_with_icon">
                                        <input type="text" class="dattaPikkara" placeholder="تا تاریخ ">
                                        <span class="lnr lnr-calendar-full"></span>
                                    </div>
                                    <div class="select-wrap">
                                        <select name="transaction_type" id="#">
                                            ...
                                            <option value="credited">برداشت </option>
                                        </select>
                                        <span class="lnr lnr-chevron-down"></span>
                                    </div>

                                    <button type="submit" class="btn btn--sm btn--round btn--color1">جستجو </button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="statement_table table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="detail">
                                    <a href="single-product.html">قالب فروشگاهی </a>
                                </td>
                                <td class="type">
                                    <span class="sale">فروش</span>
                                </td>
                                <td>50 تومان </td>
                                <td class="earning">230تومان</td>
                                <td class="action">
                                    <a href="invoice.html">نمایش </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="type">
                                    <span class="credited">اعتبار</span>
                                </td>
                                <td>50 تومان </td>
                                <td class="earning">230تومان</td>
                                <td class="action">
                            ...
                            <tr>
                                ...
                                <td class="type">
                                    <span class="withdrawal">برداشت </span>
                                </td>
                                <td>50 تومان </td>
                                <td class="earning">230تومان</td>
                                <td class="action">
...
<!--  date_plugin -->
<script src="js/date_plugin/js/jquery-1.10.1.min.js"></script>
<script src="js/date_plugin/js/persianDatepicker.js"></script>
<script>
    $(function () {
        //usage
