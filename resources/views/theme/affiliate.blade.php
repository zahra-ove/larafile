...
<body class="preload affiliate-page">
    ...
    =================================-->
    <section class="breadcrumb-area breadcrumb--center dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="page_title">
                        <h3>تبدیل شدن به یک سهامدار</h3>
                        <p class="subtitle">50٪ از خرید اولیه هر بسته تم را بدست آورید.</p>
                    </div>
    ...
    =================================-->
    <section class="affiliate_area section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <!-- start col-md-12 -->
                <div class="col-md-12">
                    <div class="section-title">
                        <h1>
                            <span class="highlighted">پیوند</span>وابسته شما
                        </h1>
                    ...
                    <div class="cardify affiliate_form">
                        <form action="#">
                            <div class="form-group">
                                ...
                                <input type="text" class="text_field" id="userName" placeholder="">
                            </div>

                            <div class="form-group">
                                <label for="userName">آدرس </label>
                                <input type="text" class="text_field" id="userUrl" placeholder="">
                            </div>
                        </form>
                        <!-- end /.form -->
                        ...
                        <div class="generated">
                            ...
                            <p class="link">http://damandarya.ir?ref=test</p>
                        </div>
                    </div>
                    <!-- end /.cardify -->
                </div>
    ...
    <!--================================
        START AFFILIATE RULES AREA
    =================================-->
    <section class="affliate_rules section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <!-- start col-md-12 -->
                <div class="col-md-12">
                    <div class="section-title">
                        <h1>چگونه
                            <span class="highlighted">کار</span>
                             می کند؟
                        </h1>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="cardify affliate_rule_module">
                        <div class="affiliate_title">
                            <span class="pcolor lnr lnr-checkmark-circle"></span>
                            <h4>مزایای شما</h4>
                        </div>
                        <div class="collapsible-content faq--card">
                            <ul class="card-content">
                                <li>
                                    <a href="#">
                                        <span></span>کسب 50٪ در خرید اولیه هر بسته تم، از جمله themeclub ما است.
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                ...
                <div class="col-md-6">
                    <div class="cardify affliate_rule_module">
                        <div class="affiliate_title">
                            <span class="mcolor4 lnr lnr-cross-circle"></span>
                            <h4>مزایای شما</h4>
                        </div>
                        <div class="collapsible-content faq--card">
                            <ul class="card-content">
