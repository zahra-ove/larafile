                ...
                <div class="col-lg-7">
                    <div class="chat_area cardify">
                        <div class="chat_area--title">
                            <h3>نوشتن پیغام جدید </h3>
                        </div>
                        <!-- end /.chat_area--title -->


                        <div class="message_composer composing">
                            <input type="text" class="recipient_field" placeholder="ارسال به ">
                            ...
                            <div class="btns">
                                <button class="btn send btn--sm btn--round">ارسال</button>
                                <label for="att">
                                    <input type="file" class="attachment_field" id="att" multiple>
                                    <span class="lnr lnr-paperclip"></span>پیوست </label>

                                <button class="btn btn--round btn--sm cancel_btn">لغو </button>
                            </div>
