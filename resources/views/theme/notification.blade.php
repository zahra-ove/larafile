...
<body class="preload notification-page">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="page-title">تمام پیغام ها </h1>
            </div>
            <!-- end /.col-md-12 -->
        </div>
        <!-- end /.row -->
                    ...
                    <div class="cardify notifications_module">
                        <div class="notification">
                            ...
                            <div class="notification__info">
                                ...
                                <div class="info">
                                    <p>
                                        <span>علی</span> شما را به علاقه مندی هاش  اضافه کرد
                                        <a href="#">تم ادمین</a>
                                    </p>
                                    <p class="time">الان</p>
                                </div>
                        ...
                        <!-- end /.notifications -->  <div class="notification">
                        <span class="line"></span>
                        <div class="notification__info">
                            <div class="info_avatar">
                                <img src="images/new/notification_head.png" alt="">
