...
<body class="preload customer-dashboard">
            ...
            <div class="col-md-12">
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li>
                            <a href="dashboard.html">داشبورد مشتری </a>
                        </li>
                    </ul>
                </div>
                <h1 class="page-title">داشبورد مشتری</h1>
            </div>
            <!-- end /.col-md-12 -->
        </div>
        <!-- end /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table withdraw__table">
                                    ...
                                    <tr>
                                        <td>ٍ#515</td>
                                        <td>1 اردیبهشت 98</td>
                                        <td class="bold">30 تومان</td>
                                        <td class="bold">
                                            <a href="#">نمایش داده و دانولد ها</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>ٍ#515</td>
