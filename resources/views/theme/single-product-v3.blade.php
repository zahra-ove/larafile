            ...
            <div class="col-lg-8">
                <div class="item-preview item-preview2">
                    <div class="prev-slide">
                        <img src="images/new/itprv2.jpg" alt="Keep calm this isn't the end of the world, the preview is just missing.">
                    </div>
                        ...
                        <div class="item-action">
                            <div class="action-btns">
                                ...
                                <a href="#" class="btn btn--round btn--lg btn--icon">
                                    <span class="lnr lnr-heart"></span>افزودن به سبد خرید </a>
                            </div>
                        </div>
                        <!-- end /.item__action -->
                    </div>
                    ...
                    <div class="tab tab2">
                        <div class="item-navigation">
                            <ul class="nav nav-tabs nav--tabs2">
                                ...
                                <li>
                                    <a href="#product-comment2" aria-controls="product-comment2" role="tab" data-toggle="tab">نظرات  </a>
                                </li>
                            </ul>
                        </div>
                        <!-- end /.item-navigation -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane product-tab fade" id="product-comment2">
                                <div class="thread">
                                    <ul class="media-list thread-list">
                                        <li class="single-thread">
                                            ...
                                            <!-- comment پاسخ -->
                                            <div class="media depth-2 پاسخ-comment" style="display: none;">
                                                <div class="media-left">
                                                    <a href="#">
                                                ...
                                                <div class="media-body">
                                                    <form action="#" class="comment-پاسخ-form">
                                                        <textarea name="پاسخ-comment" placeholder="نظر خود را بنویسید ..."></textarea>
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="images/new/m4.png" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div>
                ...
                <aside class="sidebar sidebar--single-product">
                    <div class="sidebar-card card-pricing">
                        ...
                        <div class="purchase-button">
                            <a href="#" class="btn btn--lg btn--round">دانلود </a>
                        </div>
                        <!-- end /.purchase-button -->
                    </div>
                    <!-- end /.sidebar--card -->
                    ...
                    <div class="sidebar-card card--metadata">
                        <ul class="data">
                            <li>
                                <p>
                                    <span class="lnr lnr-download pcolor"></span>مجموع دانلود </p>
                                <span>426</span>
                            </li>
                            <li>
                                <p>
                                    <span class="lnr lnr-heart scolor"></span>علاقه مند </p>
                                <span>240</span>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                    <span class="lnr lnr-eye mcolor4"></span>بازدید </p>
                                <span>6,589</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="sidebar-card card--product-infos">
                        ...
                        <ul class="infos">
                            <li>
                                ...
                                <p class="info">7 اردیبهشت 98</p>
                            </li>
                            <li>
                                <p class="data-label">به روزرسانی </p>
                                <p class="info">7 اردیبهشت 98</p>
                            </li>
                            <li>
                                <p class="data-label">نوع فایل </p>
                                <p class="info">PSD, AI, JPG</p>
                            </li>
                            <li>
                                <p class="data-label">دسته بندی </p>
                                <p class="info">psd رایگان</p>
                            </li>
                            <li>
...
<section class="overview dir-rtl">
    <div class="single-feature">
        <div class="container">
            <div class="col-md-6 v_middle">
                <h2 class="overview-title">ویژگی های قالب </h2>
                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
            </div>
            <!-- end /.col-md-6 -->

            <div class="col-md-6 v_middle">
                <img src="images/new/ov3.jpg" alt="This overview image">
            </div>
            <!-- end /.col-md-6 -->
        </div>
        <!-- end /.container -->
    ...
    <div class="single-feature bgcolor">
        <div class="container">
            <div class="col-md-6 v_middle">
                <img src="images/new/ov1.jpg" alt="This overview image">
            </div>
            <!-- end /.col-md-6 -->

            <div class="col-md-6 v_middle">
                <h2 class="overview-title">ویژگی های قالب </h2>
                <p>ورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع  </p>
                <ul>
                    <li>تمام مطالب به راحتی قابل ویرایش است</li>
                    <li>ریسپانسیو - پشتیبانی از انواع مرورگرها و دستگاه های محبوب</li>
                    <li>کد تمیز و بهینه سازی شده</li>
                    <li>کد تمیز و بهینه سازی شده</li>
                    <li>کد تمیز و بهینه سازی شده</li>
    ...
    <div class="single-feature ">
        <div class="container">
            ...
            <div class="col-md-6 v_middle">
                <img src="images/new/ov2.jpg" alt="This overview image">
            </div>
            <!-- end /.col-md-6 -->
        </div>
        <!-- end /.container -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="section-title">
                    <h1>
                        <span class="highlighted">محصولات </span>
                        مرتبط
                    </h1>
                </div>
            </div>
