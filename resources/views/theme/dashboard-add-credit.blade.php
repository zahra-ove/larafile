...
<body class="preload dashboard-add-credit">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">افزودن کارت  </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                ...
                <form action="#" name="add_credit_form">
                        ...
                        <div class="col-md-12">
                            <div class="credit_modules">
                                ...
                                <div class="modules__content">
                                    <p class="subtitle">یک مقدار را انتخاب کنید</p>
                                    <div class="amounts">
                                        <ul>
                                            <li data-price="10">
                                                <p>  10 تومان</p>
                                    ...
                                    <!-- end /.amounts -->
                                    <div class="or"></div>
                                    <p class="subtitle">مقدار را وارد کنید</p>
                                    <div class="custom_amount">
                                        <div class="input-group">
                                            <input type="text" id="rlicense" class="text_field" placeholder="برای مثال : 250">
                                            <span class="input-group-addon float-left">تومان </span>
                    ...
                    <div class="credit_modules">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modules__title">
                                    <h3>روش پرداخت و تأیید</h3>
                                </div>

                                <div class="modules__content">
                                    <p class="subtitle">چقدر اعتبار می خواهید اضافه کنید؟</p>
                                    ...
                                    <ul class="payment_method">
                                        <li>
                                            <div class="custom-radio custom_radio--big">
                                                ...
                                                <label for="opt1">
                                                    <img src="images/new/mas.jpg" alt="payment cards">
                                        ...
                                        <li>
                                            <div class="custom-radio custom_radio--big">
                                                ...
                                                <label for="opt2">
                                                    <img src="images/new/vis.jpg" alt="payment cards">
                                                    <span class="circle"></span>
                                                </label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-radio custom_radio--big">
                                                ...
                                                <label for="opt3">
                                                    <img src="images/new/ppl.jpg" alt="payment cards">
                                                    <span class="circle"></span>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="custom-radio custom_radio--big">
                                                ...
                                                <label for="opt5">
                                                    <img src="images/new/dis.jpg" alt="payment cards">
                                                    <span class="circle"></span>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="custom-radio custom_radio--big">
                                                ...
                                                <label for="opt6">
                                                    <img src="images/new/ami.jpg" alt="payment cards">
                                                    <span class="circle"></span>
                                                </label>
                                            </div>
                                        </li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="cv_code" type="text" class="text_field" placeholder="">
                                            </div>

                                            <div class="custom-radio">
                                                <input type="radio" id="opt8" class="" name="filter_opt">
                                                <label for="opt8">
                                                    <span class="circle"></span>ذخیره کارت برای دفعات بعد</label>
                                            </div>

                                            <button type="submit" class="btn btn--round btn--default">اضافه کردن اعتبار </button>
                                        </div>
                                    </div>
                                </div>
                                <!-- end /.payment_info -->
