...
<body class="preload accordion-page">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shortcode_module_title ">
                        ...
                        <div class="pull-left">
                            <a href="#" class="btn btn--md btn--round" data-target="#myModal1" data-toggle="modal">مودال 1</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="shortcode_module_title">
                        ...
                        <div class="pull-left">
                            <a href="#" class="btn btn--md btn--round" data-target="#myModal2" data-toggle="modal">مودال 2</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    =================================-->
    <!-- Modals -->
    <div class="modal fade rating_modal dir-rtl"  id="myModal1" tabindex="-1" role="dialog" aria-labelledby="rating_modal">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="rating_modal">امتیاز این مورد</h3>
                    <h4>فرآیند تحقیق محصول</h4>
                    <!--<p>-->
                ...
                <div class="modal-body">
                    <form action="#">
                                ...
                                <div class="right_content">
                                    <div class="select-wrap">
                                        <select name="review_reason" id="rev">
                                            <option value="design">کیفیت طراحی</option>
                                            <option value="customization">سفارشی سازی</option>
                                            <option value="support">پشتیبانی</option>
                                            <option value="performance">کارایی</option>
                                            <option value="documentation">به خوبی مستند شده است</option>
                                        </select>
                        ...
                        <div class="rating_field">
                            <label for="rating_field">نظرات</label>
                            <textarea name="rating_field" id="rating_field" class="text_field" placeholder="لطفا دلیل خود را برای کمک به طراح بنویسید"></textarea>
                            <p class="notice">نظر شما به صورت عمومی قابل مشاهده و طراح می تواند به نظر شما پاسخ دهد . </p>
                        </div>
                        <button type="submit" class="btn btn--round btn--default">ارسال نظر</button>
                        <button class="btn btn--round modal_close" data-dismiss="modal">لغو</button>
                    </form>
                    <!-- end /.form -->
                </div>
                <!-- end /.modal-body -->
    ...
    <!-- Modal 2 -->
    <div class="modal fade rating_modal item_remove_modal dir-rtl" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModal2">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">آیا مطمئنید که این مورد را حذف کنید؟</h3>
                    <p>شما نمی توانید این فایل را بازیابی کنید!
                         
                    </p>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <button type="submit" class="btn btn--round btn-danger btn--default">حذف</button>
                    <button class="btn btn--round modal_close" data-dismiss="modal">لغو</button>
                </div>
                <!-- end /.modal-body -->
            </div>
