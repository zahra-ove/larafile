...
<head>
    ...
    <meta name="description" content="MartPlace -  App landing responsive html5 Template">
    <meta name="keywords" content="app, app landing, product landing, digital, material, html5">


    <title>دریا  -داشبورد </title>
...
<body class="preload dashboard-page has_chart">
                            ...
                            <div class="pull-right">
                                ...
                                <div class="select-wrap">
                                    <select name="months" class="period_selector">
                                        ...
                                        <option value="feb">اردیبهشت </option>
                                        <option value="mar">خرداد </option>
                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4">
                                        <div class="single_stat_data">
                                            ...
                                            <p>مجموع
                                                <span>فروش </span> در این ماه </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 text-center col-sm-4">
                                        <div class="single_stat_data">
                                            <h4 class="single_stat__title">2000 تومان  </h4>
                                            <p>مجموع
                                                <span>درآمد
 
</span>در این ماه </p>
                                ...
                                <tr>
                                    <td>
                                        <div class="country_flag">
                                            <img src="images/new/flam.jpg" alt="Country Flag">
                                        </div>
                                    ...
                                    <div class="chart_top ">
                                        <div class="v_refer">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li>
                                                    <a href="#visit_source" class="active" aria-controls="visit_source" role="tab" data-toggle="tab">منبع سایت بازدید</a>
                                                </li>
                                                <li>
                                                    <a href="#referrals" aria-controls="referrals" role="tab" data-toggle="tab">ارجاعات</a>
                                                </li>
                                            </ul>
                                            <div class="select-wrap">
                                        ...
                                        <div class="charts">
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade show" id="visit_source">
                                                    <canvas id="piechart" dir="ltr"></canvas>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade show referrals_data" id="referrals">
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <p class="visit">
                                                                <span>visitors:</span>250</p>
                                                        </li>

                                                        <li>
                                                            <p class="site">dribbble.com</p>
                                                            <p class="visit">
                                                                <span>visitors:</span>450</p>
                                                        </li>

                                                        <li>
                                                            <p class="site">behance.com</p>
                                                            <p class="visit">
                                                                <span>visitors:</span>341</p>
                                                        </li>

                                                        <li>
                                                            <p class="site">domain.com</p>
                                                            <p class="visit">
                                                                <span>visitors:</span>98</p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="single_sell">
                                        <div class="single_sell__thumb-title">
                                            <div class="prod_thumbnail">
                                                <img src="images/new/prodthumb.png" alt="product thumbnail">
                                            </div>
                                            <div class="prod_title">
                                                <h4>قالب روشگاهی ورد پرس </h4>
                                                <div class="category">
                                                    <img src="images/new/catword.png" alt="category">
                                                    <span>وردپرس </span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <div class="single_buyer">
                                        <div class="buyer__thumb_title">
                                            <div class="thumb">
                                                <img src="images/new/buyr1.jpg" alt="Buyer Images">
                                            </div>
                                            <div class="title">
                                                <h4>علی رضوی</h4>
                                                <p>ایران </p>
                                        ...
                                        <div class="media depth-2 reply-comment">
                                            ...
                                            <div class="media-body">
                                                <form action="#" class="comment-reply-form">
                                                    <textarea class="bla" name="reply-comment" placeholder="متن مورد نظر را بنویسید ..."></textarea>
                                                    <button class="btn btn--md btn--round">ثبت نظر </button>
                                                </form>
                                            </div>
                                        </div>
                                        <!-- comment reply -->
                                ...
                                <div class="message_composer">
                                    ...
                                    <div class="btns">
                                        ...
                                        <label for="att">
                                            ...
                                            <span class="lnr lnr-paperclip"></span>ضمیمه</label>
                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="btns">
                    <a href="#" class="btn btn--round btn--md btn--danger">Confirm</a>
                    <a href="#" class="btn btn--round btn--md btn--default" data-dismiss="modal" aria-label="Close">
