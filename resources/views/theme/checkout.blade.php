...
<head>
    ...
    <title>دریا  -بازبینی سفارش</title>
                    ...
                    <div class="row">
                                ...
                                <div class="information__set">
                                    <div class="information_wrapper form--fields">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first_name" class="text_field" placeholder="" value="امیر حسین ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="last_name" class="text_field" placeholder="" value="دامن دریا ">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end /.row -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email1" class="text_field" placeholder="ایمیل " value="amir.d79@yahoo.com">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address1" class="text_field" placeholder="آدرس ">
                                        </div>

                                        <div class="form-group">
                                            <label for="address2">ادامه آدرس</label>
                        ...
                        <div class="col-lg-6">
                            <div class="information_module order_summary">
                                ...
                                <ul>
                                    <li class="item">
                                        <a href="single-product.html" target="_blank">قالب چند فروشندگی</a>
                                        <span>60 تومان</span>
                                    </li>   <li class="item">
                                        <a href="single-product.html" target="_blank">قالب چند فروشندگی</a>
                                        <span>60 تومان</span>
                            ...
                            <div class="information_module payment_options">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <img src="images/new/cards.png" alt="Visa Cards">
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <img src="images/new/paypal.png" alt="Visa Cards">
                                    </li>
