...
<head>
    ...
    <title>دریا - انجمن پشتیبانی</title>
...
<body class="preload support-forum-page">
                        ...
                        <div class="support_thread_list cardify">
                            <div class="support_thread--single">
                                <div class="support_thread_info">
                                    <a href="support-forum-detail.html" class="support_title">منوی بالا و پایین صفحه وب سایت پاسخگو
                                        <span class="pinned">بسته شده</span>
                                    </a>
                                    <div class="suppot_query_tag">
                                        <a href="#" class="user">
                                            <img class="poster_avatar" src="images/new/support_avat1.png" alt="Support Avatar"> میتس چاودا</a>
                                ...
                                <div class="support_thread_meta">
                                    <ul>
                                        <li class="answer_time">
                                            <img src="images/new/support_avat4.png" alt="Support images">
