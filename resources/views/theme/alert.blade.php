        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">هشدار ها </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                    ...
                    <div class="shortcode_modules">
                        ...
                        <div class="modules__content">
                            <div class="alert alert-default" role="alert">
                                ...
                                <strong>سلام دنیا!</strong>این پیش فرض پنجره  پیام هشدار است.
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <strong>آفرین!</strong> شما با موفقیت این پیام هشدار مهم را خوانده اید.
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span class="lnr lnr-cross" aria-hidden="true"></span>
                                </button>
                            </div>
                            <div class="alert alert-info" role="alert">
                                <span class="alert_icon lnr lnr-bullhorn"></span>
                                <strong>توجه!</strong>این هشدار به توجه شما نیاز دارد، اما فوق العاده مهم نیست.
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span class="lnr lnr-cross" aria-hidden="true"></span>
                                </button>
                            </div>
                            <div class="alert alert-warning" role="alert">
                                ...
                                <strong>اخطار!</strong> بهتر است خودتان را بررسی کنید، خیلی خوب نیستید.
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span class="lnr lnr-cross" aria-hidden="true"></span>
                                </button>
                            </div>
                            <div class="alert alert-danger" role="alert">
                                <span class="alert_icon lnr lnr-warning"></span>
                                <strong>ای وای!</strong> چند چیز را تغییر دهید و دوباره امتحان کنید.
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span class="lnr lnr-cross" aria-hidden="true"></span>
                                </button>
                            </div>
