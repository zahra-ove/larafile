...
<head>
    ...
    <title>دریا  -سوالات متداول </title>
...
<body class="preload faq-page">
                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="#">مربوط به طراح </a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">سولات متداول مربوط به طراح </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
    ...
    <!--================================
            START FAQ AREA
    =================================-->
    <section class="faq_area section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <aside class="sidebar faq--sidebar">
                        <div class="sidebar-card faq--card">
                            <div class="faq-title">
                                <span class="lnr lnr-file-add"></span>
                                <h4>سوالات خریداران  (36)</h4>
                            </div>
                            <div class="collapsible-content">
                                <ul class="card-content">
                                    <li>
                                        <a href="#">
                                            <span></span>چگونه میتوانم موضوعی را  به روزرسانی کنم؟</a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span></span>چگونه میتوانم موضوعی را  به روزرسانی کنم؟</a>
                                ...
                                <a href="#" class="btn btn--round btn--sm btn--faq">نمایش همه </a>
                            </div>
