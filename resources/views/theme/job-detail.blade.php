...
<body class="preload carrier-page">
    ...
    <!--================================
        START JOB HERO AREA
    =================================-->
    <section class="job_hero_area job_detail bgimage dir-rtl">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="job_hero_content">
                        <h1>مهندس ارشد اجرایی</h1>
                        <div class="job_date">
                            <p>
                                <span class="lnr lnr-map-marker"></span> شهر ایران </p>
                            <p>
                                <span class="lnr lnr-calendar-full"></span> 17 اردیبهشت 98</p>
                        </div>
                    </div>
                    <!-- end /.job_hero_content -->

                    <a href="#" class="btn btn--round btn--white btn--lg">درخواست کن</a>
                </div>
                <!-- end /.col-md-8 -->
            </div>
            <!-- end /.row -->
    ...
    <!--================================
        START JOB AREA
    =================================-->
    <section class="job_area section--padding2 dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="job_detail_module information">
                        <h3 class="job__title">اطلاعات سریع </h3>
                    ...
                    <div class="job_detail_module">
                        <h3 class="job__title">توضیحات کار </h3>
                        <div class="job__content">
                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
                        </div>

                        <h3 class="job__title">مسئولیت ها</h3>
                        <div class="job__content">
                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
                        ...
                        <h3 class="job__title">حداقل امتیازات
                             
                        </h3>
                        <div class="job__content">
                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
    ...
    <section class="apply_area section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <!-- start col-md-12 -->
                <div class="col-md-12">
                        ...
                        <form action="#">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="fname" type="text" placeholder="نام ">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="cv_upload" class="cv_upload">
                                    <span class="text">آپلود مدارک</span>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn--round btn--default">ثبت اطلاعات </button>
                            </div>
                        </form>
                    </div>
                    <!-- end /.col-md-12 -->
