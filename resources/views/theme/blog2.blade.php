        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="single_blog blog--default">
                    <figure>
                        <img src="images/new/bb1.jpg" alt="Blog image">
                        ...
                        <figcaption>
                            ...
                            <div class="btn_text">
                                ...
                                <a href="single-blog.html" class="btn btn--md btn--round">اطلاعات بیشتر </a>
                            </div>
                        </figcaption>
                    </figure>
                </div>
                    ...
                    <div class="sidebar-card card--blog_sidebar card--category">
                        ...
                        <div class="collapsible-content">
                            <ul class="card-content">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="lnr lnr-chevron-right"></span>جوملا
                                        <span class="item-count"> 45</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="lnr lnr-chevron-right"></span>لاراول
                                        <span class="item-count">13</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="lnr lnr-chevron-right"></span>محبوب ترین ها
                                        <span class="item-count">08</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="lnr lnr-chevron-right"></span>دیگر مقالات
