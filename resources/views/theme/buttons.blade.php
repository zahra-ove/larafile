        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">دکمه ها </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                ...
                <div class="col-md-12">
                    <div class="shortcode_modules">
                        ...
                        <div class="modules__content">
                            <button class="btn btn-lg btn--round">Primary</button>
                    ...
                    <div class="shortcode_modules">
                        <div class="modules__title">
                            <h3>دکمه ها با آیکن ها</h3>
                        </div>
                        <div class="modules__content">
                            <button class="btn btn-lg btn--icon btn--round">
                                <span class="lnr lnr-home"></span>Large</button>
                            <button class="btn btn--icon btn-default btn--round btn-secondary">
                                <span class="lnr lnr-cog"></span>Default</button>
                            <button class="btn btn--icon btn-md btn--round btn-success">
                                <span class="lnr lnr-bullhorn"></span>Medium</button>
                            <button class="btn btn--icon btn-sm btn--round btn-info">
                                <span class="lnr lnr-thumbs-up"></span>Small</button>
                            <button class="btn btn--icon btn-sm btn-warning">
                                <span class="lnr lnr-alarm"></span>Small</button>
                        </div>
                    </div>
                    ...
                    <div class="shortcode_modules">
                        ...
                        <div class="modules__content">
                            <button class="btn btn-lg">Primary</button>
                    ...
                    <div class="shortcode_modules">
                        ...
                        <div class="modules__content">
                            <button class="btn btn--round btn--bordered btn-lg">Primary</button>
                            <button class="btn btn--round btn--bordered btn-lg btn-secondary">Secondary</button>
                            <button class="btn btn--round btn--bordered btn-lg btn-success">Success</button>
                            <button class="btn btn--round btn--bordered btn-lg btn-info">Info</button>
                            <button class="btn btn--round btn--bordered btn-lg btn-warning">Warning</button>
                            <button class="btn btn--round btn--bordered btn-lg btn-danger">Danger</button>
                            <button class="btn btn--round btn--bordered btn-lg btn-dark">Dark</button>
                        </div>
                    </div>

                    <div class="shortcode_modules">
                        <div class="modules__title">
                            <h3>اندازه دکمه ها</h3>
                        </div>
                        <div class="modules__content">
                            <div>
                                <button class="btn btn--round btn-lg">Button Large</button>
                                <button class="btn btn--round btn--bordered btn-lg btn-secondary">Button Large</button>
                                <button class="btn btn-lg btn-success">Button Large</button>
                                <button class="btn btn--icon btn-lg btn--round btn-secondary">
                                    <span class="lnr lnr-cog"></span>Button Large</button>
                            </div>

                            <div>
                                <button class="btn btn--round btn-default">Button Default</button>
                                <button class="btn btn--round btn--bordered btn-default btn-secondary">Button Default</button>
                                <button class="btn btn-default btn-success">Button Default</button>
                                <button class="btn btn--icon btn-default btn--round btn-secondary">
                                    <span class="lnr lnr-cog"></span>Button Default</button>
                            </div>

                            <div>
                                <button class="btn btn--round btn-md">Button Medium</button>
                                <button class="btn btn--round btn--bordered btn-md btn-secondary">Button Medium</button>
                                <button class="btn btn-md btn-success">Button Medium</button>
                                <button class="btn btn--icon btn-md btn--round btn-secondary">
                                    <span class="lnr lnr-cog"></span>Button Medium</button>
                            </div>

                            <div>
                                <button class="btn btn--round btn-sm">Button Small</button>
                                <button class="btn btn--round btn--bordered btn-sm btn-secondary">Button Small</button>
                                <button class="btn btn-sm btn-success">Button Small</button>
                                <button class="btn btn--icon btn-sm btn--round btn-secondary">
                                    <span class="lnr lnr-cog"></span>Button Small</button>
                            </div>
                        </div>
                    </div>
                </div>
