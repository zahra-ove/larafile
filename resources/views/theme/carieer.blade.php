...
<body class="preload carrier-page">
    ...
    <!--================================
        START JOB HERO AREA
    =================================-->
    <section class="job_hero_area bgimage dir-rtl">
        <div class="bg_image_holder">
            <img src="images/new/job_hero.jpg" alt="">
        </div>
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="job_hero_content">
                        <h1>یک کار در
                            <span class="highlight">شرکت ما</span> بگیرید
                    ...
                    <a href="#" class="btn btn--round btn--white btn--lg">مقعیت های خالی </a>
                </div>
                <!-- end /.col-md-8 -->
            </div>
            <!-- end /.row -->
    ...
    <!--================================
        START JOB AREA
    =================================-->
    <section class="job_area section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <!-- start col-md-12 -->
                <div class="col-md-12">
                    <div class="section-title">
                        <h1>
                            <span class="highlighted">موقعیت </span>
                            های خالی
                        </h1>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="card_style2">
                        <h4 class="card_style2__title">سازنده وردپرس ارشد مورد نیاز است</h4>
                        <div class="card_style2__location_type">
                            <p>
                                <span class="lnr lnr-map-marker"></span>شهر نیویورک</p>
                            <span class="type pcolorbg">تمام وقت</span>
                        </div>
                        <a href="job-detail.html">برای اطلاعات بیشتر درخواست بدهید </a>
                    </div>
                    <!-- end /.single_job -->
                </div>
                <!-- end /.col-md-6 -->
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="card_style2">
                        <h4 class="card_style2__title">نیاز به یک فرانت کار </h4>
                        <div class="card_style2__location_type">
                            <p>
                                <span class="lnr lnr-map-marker"></span>شهر نیویورک</p>
                            <span class="type mcolorbg1">نیمه وقت </span>
                        </div>
                        <a href="job-detail.html">برای اطلاعات بیشتر درخواست بدهید </a>
                    </div>
                    <!-- end /.card_style2 -->
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="card_style2">
                        <h4 class="card_style2__title">بک اند کار php</h4>
                        <div class="card_style2__location_type">
                            <p>
                                <span class="lnr lnr-map-marker"></span>تهران </p>
                            <span class="type scolorbg">دور کار</span>
                        </div>
                        <a href="job-detail.html">برای اطلاعات بیشتر درخواست بدهید </a>
                    </div>
                    <!-- end /.card_style2 -->
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="card_style2">
                        <h4 class="card_style2__title">مدیر خرید </h4>
                        <div class="card_style2__location_type">
                            <p>
                                <span class="lnr lnr-map-marker"></span>تهران </p>
                            <span class="type pcolorbg">تمام وقت</span>
    ...
    <!--================================
        START FEATURE AREA
    =================================-->
    <section class="feature_area section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <!-- start col-md-12 -->
                <div class="col-md-12">
    ...
    <section class="content_block5 section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-6 v_middle">
                    <div class="content_block5_content">
                        <h1>اطلاعات بیشتر در مورد
                            <span class="highlighted">ما</span>
                        </h1>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>

                        <a href="about.html" class="btn btn--default btn--round">درباره ی ما </a>
                    </div>
                </div>
                <!-- end /.col-md-5 -->

                <div class="col-lg-6 col-md-6 offset-lg-1 v_middle">
                    <img src="images/new/knous.jpg" alt="The Image is not available or broken">
                </div>
                <!-- end /.col-md-6 -->
            </div>
            <!-- end /.row -->
