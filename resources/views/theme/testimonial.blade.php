...
<body class="preload testimonial-page">
    ...
    <!--================================
        START PRICING AREA
    =================================-->
    <section class="tesimonial-page-area section--padding dir-rtl">
        <div class="container">
            <div class="row">
                <!-- start col-md-12 -->
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="testimonial_video">
                        <figure>
                            <img src="images/new/testv1.jpg" alt="testimonial video 1">

                            <figcaption class="video_play">
                                <button data-toggle="modal" data-target="#myModal">
                                    <img src="images/new/vpla.png" alt="Play button">
                                </button>
                            </figcaption>
                        </figure>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="testimonial_video">
                        <figure>
                            <img src="images/new/testv2.jpg" alt="testimonial video 1">
    ...
    <div class="modal fade testimonial_vid" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <iframe height="600" src="https://www.youtube.com/embed/0O-IsnsmQ5Q" allowfullscreen></iframe>
            </div>
        </div>
    </div>
