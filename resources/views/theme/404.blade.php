...
<head>
    ...
    <title>دریا  - صفحه ای یافت نشد </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3 text-center">
                    <img src="images/new/404.png" alt="404 page">
                    <div class="not_found">
                        <h3>وای! صفحه یافت نشد
                             
                        </h3>
                        <a href="index.html" class="btn btn--round btn--default">بازگشت به خانه</a>
                    </div>
                </div>
            </div>
        </div>
