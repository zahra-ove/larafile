            ...
            <div class="product_archive">
                <div class="title_area">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <h4 class="add_info">اطلاعات اضافی</h4>
                        </div>
                        <div class="col-md-2">
                            <h4>قیمت </h4>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="single_product clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-5">
                                    <div class="product__description">
                                        <img src="images/new/pur2.jpg" alt="Purchase image">
                                        <div class="short_desc">
                                            <h4>قالی html چند فروشندگی </h4>
...
<div class="modal fade rating_modal dir-rtl"  id="myModal" tabindex="-1" role="dialog" aria-labelledby="rating_modal">
