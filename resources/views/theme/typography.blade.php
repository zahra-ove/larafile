                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="#">تایپو گرافی</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">تایپو گرافی</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="shortcode_modules">
                        ...
                        <div class="modules__content typog">
                            <h1>h1. سربرگ پیشفرض</h1>
                            <h2>h2. سربرگ پیشفرض</h2>
                            <h3>h3. سربرگ پیشفرض</h3>
                            <h4>h4. سربرگ پیشفرض</h4>
                            <h5>h5. سربرگ پیشفرض</h5>
                            <h6>h6. سربرگ پیشفرض</h6>
                        </div>
                    </div>
                    ...
                    <div class="shortcode_modules">
                        ...
                        <div class="modules__content typog">
                            <h1 class="pcolor">h1. سربرگ پیشفرض</h1>
                            <h2 class="scolor">h2. سربرگ پیشفرض</h2>
                            <h3 class="mcolor1">h3. سربرگ پیشفرض</h3>
                            <h4 class="mcolor2">h4. سربرگ پیشفرض</h4>
                            <h5 class="mcolor3">h5. سربرگ پیشفرض</h5>
                            <h6 class="mcolor4">h6. سربرگ پیشفرض</h6>
                        </div>
                    </div>

                    <div class="shortcode_modules">
                        <div class="modules__title">
                            <h3>پاراگراف استاندارد</h3>
                        </div>
                        <div class="modules__content typog text-justify">
