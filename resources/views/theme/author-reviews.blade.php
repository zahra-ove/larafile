...
<head>
    ...
    <title>دریا  -نظرات کاربران </title>
                    ...
                    <aside class="sidebar sidebar_author">
                        ...
                        <div class="sidebar-card author-menu">
                            <ul>
                                ...
                                <li>
                                    <a href="author-reviews.html" class="active">نظرات مشتریان</a>
                                </li>
                                <li>
                        ...
                        <div class="col-md-12">
                            <div class="product-title-area">
                                <div class="product__title">
                                    <h2>
                                        <span class="bold">26</span> نظر مشتریان </h2>
                                </div>
                            </div>
                                                ...
                                                <div class="clearfix">
                                                    <div class="pull-right">
                                                        <div class="media-heading">
                                                            ...
                                                            <a href="#" class="rev_item">پنل ادمین بوت استرپ 4</a>
                                                        </div>
                                                        <div class="rating product--rating">
                                                            <ul>
                                                                <li>
                                                        ...
                                                        <span class="review_tag">پشتیبان</span>
                                                    </div>

                                                    <div class="pull-left rev_time">9 ساعت پیش</div>
                                                </div>
