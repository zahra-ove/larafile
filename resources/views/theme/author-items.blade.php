...
<body class="preload author-items">
                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="#">محصولات طراح</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">محصولات طراح</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                    ...
                    <aside class="sidebar sidebar_author">
                        ...
                        <div class="sidebar-card author-menu">
                            <ul>
                                ...
                                <li>
                                    <a href="author-items.html" class="active">آیتم های طراح </a>
                                </li>
                                <li>
                                    <a href="author-reviews.html">نظرات مشتریان</a>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="filter-bar clearfix filter-bar2">
                                <div class="filter__option filter--text pull-right mr-3">
                                    <p>
                                        <span>4,369</span> آیتم</p>
                                </div>

                                <div class="pull-right">
                                    <div class="filter__option filter--dropdown">
                                        <a href="#" class="dropdown-trigger dropdown-toggle" id="drop1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">دسته بندی
                                    ...
                                    <div class="filter__option filter--dropdown">
                                        ...
                                        <ul class="custom_dropdown dropdown-menu" aria-labelledby="drop2">
                                            ...
                                            <li>
                                                <a href="#">محصولات محبوب </a>
                                            </li>
                                            <li>
                                                <a href="#">محصولات جدید </a>
                                            </li>
                                            <li>
                                                <a href="#">بهترین محصولات </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
