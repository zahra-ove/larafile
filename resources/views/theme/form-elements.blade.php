...
<body class="preload form-element-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">عناصر فرم</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                                ...
                                <div class="col-md-6 offset-md-1">
                                    <form action="#">
                                        <div class="form-group">
                                            <label for="f1">فیلد ورودی 1</label>
                                            <input type="text" id="f1" class="text_field" placeholder="نام کاربری ">
                                        </div>
                                        <div class="form-group">
                                            <label for="f2">فیلد ورودی 2</label>
                                            <input type="text" id="f2" placeholder="نام ">
                                        </div>
                                        <div class="form-group">
                                            <label for="category">فیلد 1 را انتخاب کنید</label>
                                        ...
                                        <div class="form-group">
                                            <label for="selected">انتخاب چندگانه</label>
                                        ...
                                        <div class="form-group">
                                            <label for="cv_upload">فیلد آپلود </label>
                                        ...
                                        <div class="form-group">
                                            <label for="rlicense">ورودی با افزونه</label>
                                        ...
                                        <div class="form-group">
                                            <p class="label">چک باکس 1</p>
                                            <div class="custom_checkbox">
                                                <input type="checkbox" id="opt1" class="" name="mail_rating_reminder" checked="">
                                                <label for="opt1">
                                                    <span class="shadow_checkbox"></span>
                                                    <span> من شرایط و ضوابط را مطالعه کرده ام و موافقم</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <p class="label">چک باکس 2</p>
                                            <div class="custom-checkbox2">
                                                <input type="checkbox" id="opti6" class="" name="filter_opt">
                                                <label for="opti6">
                                                    <span class="circle"></span>انتخاب 1</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <p class="label">رادیو باتم 1</p>
                                            ...
                                            <div class="custom-radio">
                                                <input type="radio" id="opt6" class="" name="filter_opt">
                                                <label for="opt6">
                                                    <span class="circle"></span>انتخاب 2</label>
                                            </div>
                                            <div class="custom-radio">
                                                <input type="radio" id="opt7" class="" name="filter_opt">
                                                <label for="opt7">
                                                    <span class="circle"></span>انتخاب 3</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="textarea1">جعبه متن  1</label>
                                            <textarea class="text_field" name="txt" id="textarea1" placeholder="متن خود را بنویسید"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="textarea2">جعبه متن  2</label>
                                            <textarea class="" name="txt2" id="textarea2" placeholder="متن خود را بنویسید"></textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="datp1">تاریخ </label>
                                                    <div class="input_with_icon">
                                                        <input id="datp1" type="text" class="dattaPikkara" placeholder="از">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="datp2">تاریخ </label>
                                                    <div class="input_with_icon">
                                                        <input id="datp2" type="text" class="dattaPikkara" placeholder="تا">
                                                        <span class="lnr lnr-calendar-full"></span>
                                                    </div>
                                                </div>
                                            </div>
