...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/new/favicon.png">
</head>

<body class="preload accordion-page">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-6 v_middle">
                        <div class="logo">
                            <a href="index.html">
                                <img src="images/new/logo.png" alt="logo image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <!-- end /.col-md-3 -->
                        ...
                        <div class="author-area">
                                        ...
                                        <div class="dropdowns notification--dropdown">
                                            ...
                                            <div class="notifications_module">
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/notification_head.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/notification_head2.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/notification_head3.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/notification_head4.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                                <span>اندرسون</span> اضافه شده به علاقه مندی های شما
                                        ...
                                        <div class="dropdowns messaging--dropdown">
                                            ...
                                            <div class="messages">
                                                ...
                                                <a href="message.html" class="message recent">
                                                    <div class="message__actions_avatar">
                                                        <div class="avatar">
                                                            <img src="images/new/notification_head5.png" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- end /.actions -->
                                                ...
                                                <a href="message.html" class="message">
                                                    <div class="message__actions_avatar">
                                                        <div class="avatar">
                                                            <img src="images/new/notification_head6.png" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- end /.actions -->
                                            ...
                                            <div class="cart_area">
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="images/new/capro1.jpg" alt="cart product thumbnail">
                                                        </div>

                                                        <div class="info">
                                                            <a class="title" href="single-product.html">قالب ورد پرس  دریا </a>
                                                            <div class="cat">
                                                                <a href="#">
                                                ...
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="images/new/capro2.jpg" alt="cart product thumbnail">
                                                        </div>
                            ...
                            <div class="author-author__info inline has_dropdown">
                                <div class="author__avatar">
                                    <img src="images/new/usr_avatar.png" alt="user avatar">
    ...
    <!--================================
            START BADGE AREA
    =================================-->
    <section class="badges author-rank dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="author-badges">
                        <div class="badge-single">
                            <img src="images/new/svg/author_rank_bronze.svg" alt="" class="svg">
                            <h3>طراح برنز</h3>
                            <p>فروش بیش از 50،000 تومان </p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/author_rank_golden.svg" alt="" class="svg">
                            <h3>طراح طلایی</h3>
                            <p>فروش بیش از 100،000 تومان </p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/author_rank_diamond.svg" alt="" class="svg">
                            <h3>طراح الماس</h3>
                            <p>فروش بیش از 1،000،000 تومان </p>
                        </div>
                    </div>
    ...
    <section class="badges community-badges dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                    ...
                    <div class="author-badges">
                        <div class="badge-single">
                            <img src="images/new/svg/author_level_3.svg" alt="" class="svg">
                            <h3>سطح طراح
                                 
                            </h3>
                            <p>فروش بیش از 100،000 تومان</p>
                        ...
                        <div class="badge-single">
                            <img src="images/new/svg/affiliate_level_1.svg" alt="" class="svg">
                            <h3>سطح سهامداران</h3>
                            <p>اوردن بیش از 50 خریدار </p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/collection_level_1.svg" alt="" class="svg">
                            <h3>مجموعه سطح</h3>
                            <p>خرید بیش از 20 فایل </p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/contest_winner.svg" alt="" class="svg">
                            <h3>برنده مسابقه</h3>
                            <p>برنده رقابت در فروشگاه </p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/copyright.svg" alt="" class="svg">
                            <h3>کپی رایت</h3>
                            <p>حق نسخه برداری محافظت شده است</p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/country.svg" alt="" class="svg">
                            <h3>ایران</h3>
                            <p>کشور محل سکونت: ایران
                            </p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/exclusive_author.svg" alt="" class="svg">
                            <h3>طراح اختصاصی
                                 
                            </h3>
                            <p>فروش اقلام منحصرا در فروشگاه</p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/featured_author.svg" alt="" class="svg">
                            <h3>طراح ویژه
                                 
                            </h3>
                            <p>ساخته شده آن را به تالار افتخارات طراحان </p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/featured_item.svg" alt="" class="svg">
                            <h3>مورد ویژه
                                 
                            </h3>
                            <p>یک مورد در فروشگاه برجسته بود</p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/forum_superstar.svg" alt="" class="svg">
                            <h3>انجمن سوپراستار</h3>
                            <p>سهم بزرگی را در اختیار ما قرار داد</p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/members_years.svg" alt="" class="svg">
                            <h3>عضو برای 2 سال
                            </h3>
                            <p>مدت 2 سال عضو بازار بوده است.</p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/recommended.svg" alt="" class="svg">
                            <h3>توصیه</h3>
                            <p>این نویسنده دارای توصیه 100٪ مثبت است.</p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/support.svg" alt="" class="svg">
                            <h3>پشتیبانی طراح
                                 
                            </h3>
                            <p>نویسنده ارائه دهنده پشتیبانی از اقلام خود را ارائه می دهد.</p>
                        </div>
                        <div class="badge-single">
                            <img src="images/new/svg/top_seller.svg" alt="" class="svg">
                            <h3>فروشنده برتر
                                 
                            </h3>
                                <p>آیتم  در یک ماه به بهترین فروشندگان تبدیل شد .</p>
                        </div>
                    </div>
                    <!-- ends: .author-rank-badges -->
                </div>
    ...
    <section class="badges community-badges bgcolor dir-rtl">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h1>مدالها قفل شده اند</h1>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </p>
                    </div>
                    <div class="author-badges">
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/author_level_3.svg" alt="" class="svg locked">
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/affiliate_level_1.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" aria-hidden="true"></span>
                            </div>
                            <h3>سطح سهامداران</h3>
                            <p>اوردن بیش از 50 خریدار </p>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/collection_level_1.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                            <h3>مجموعه سطح</h3>
                            <p>خرید بیش از 20 فایل </p>
                        </div>
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/contest_winner.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                            <h3>برنده مسابقه</h3>
                            <p>برنده رقابت در فروشگاه </p>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/copyright.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                            <h3>کپی رایت</h3>
                            <p>حق نسخه برداری محافظت شده است</p>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/country.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/exclusive_author.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/featured_author.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                            <h3>طراح ویژه
                                 
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/featured_item.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                            <h3>مورد ویژه
                                 
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/forum_superstar.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                            <h3>انجمن سوپراستار</h3>
                            <p>سهم بزرگی را در اختیار ما قرار داد</p>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/members_years.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/recommended.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/support.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                        ...
                        <div class="badge-single">
                            <div class="svg_wrapper">
                                <img src="images/new/svg/top_seller.svg" alt="" class="svg locked">
                                <span class="fa fa-lock" area-hidden="true"></span>
                            </div>
                            <h3>فروشنده برتر
                                 
