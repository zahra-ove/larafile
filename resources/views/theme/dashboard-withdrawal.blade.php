                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="dashboard_menu">
                            ...
                            <li class="active">
                                <a href="dashboard-withdrawal.html">
                                    <span class="lnr lnr-briefcase"></span>برداشت </a>
                            </li>
                        </ul>
                        <!-- end /.dashboard_menu -->
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="dashboard_title_area clearfix">
                            ...
                            <div class="pull-left">
                                <a href="add-payment-method.html" class="btn btn--round btn--md">افزودن روش پرداخت </a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="modules__content">
                                        <p class="subtitle"> روش  خود را برای
                                            <a href="#">برداشت از درآمد </a>
                                            انتخاب کنید
                                        </p>
                                        <div class="options">
                                            <div class="custom-radio">
                                                ...
                                                <label for="opt1">
                                                    <span class="circle"></span>درگاه پرداخت ملت </label>
                                            </div>

                                            <div class="custom-radio">
                                                <input type="radio" id="opt2" class="" name="filter_opt">
                                                <label for="opt2">
                                                    <span class="circle"></span>پی پال </label>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="modules__content">
                                        <p class="subtitle">چقدر مبلغی را می خواهید برداشت کنید؟</p>
                                        <div class="options">
                                            <div class="custom-radio">
                                                <input type="radio" id="opt4" class="" name="filter_opt">
                                                <label for="opt4">
                                                    <span class="circle"></span>موجودی :
                                                    <span class="bold">690.50 تومان</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="custom-radio">
                                                ...
                                                <label for="opt5">
                                                    <span class="circle"></span>مقدار جزئی ...</label>
                                            </div>
                                            ...
                                            <div class="withdraw_amount">
                                                ...
                                                <span class="fee">هزینه 200 تومان در هر لغو</span>
                                            </div>
                                        </div>

                                        <div class="button_wrapper">
                                            <button type="submit" class="btn btn--round btn--md">برداشت </button>
                                            <a href="#" class="btn btn--round btn-sm cancel_btn">لغو</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- end /.col-md-6 -->
