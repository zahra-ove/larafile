        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title">لیست فایل ها -ویرایش فایل </h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                    ...
                    <div class="col-md-12">
                        <div class="filter-bar dashboard_title_area clearfix filter-bar2">
                            <div class="dashboard__title dashboard__title pull-right">
                                <h3>مدیریت آیتم ها </h3>
                            </div>

                            <div class="pull-left">
                                <div class="filter__option filter--text">
                                    <p>
                                        <span>26</span> محصول</p>
                                </div>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="edit-item.html">
                                                    <span class="lnr lnr-pencil"></span>ویرایش </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <span class="lnr lnr-eye"></span>مخفی </a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#myModal2" class="delete">
                                                    <span class="lnr lnr-trash"></span>حذف</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
