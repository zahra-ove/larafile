            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-6 v_middle">
                        <div class="logo">
                            <a href="index.html">
                                <img src="images/new/new/logo.png" alt="logo image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <!-- end /.col-md-3 -->
                        ...
                        <div class="author-area">
                                        ...
                                        <div class="dropdowns notification--dropdown">
                                            ...
                                            <div class="notifications_module">
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/new/notification_head.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/new/notification_head2.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/new/notification_head3.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="images/new/new/notification_head4.png" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                                <span>اندرسون</span> اضافه شده به علاقه مندی های شما
                                        ...
                                        <div class="dropdowns messaging--dropdown">
                                            ...
                                            <div class="messages">
                                                ...
                                                <a href="message.html" class="message recent">
                                                    <div class="message__actions_avatar">
                                                        <div class="avatar">
                                                            <img src="images/new/new/notification_head5.png" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- end /.actions -->
                                                ...
                                                <a href="message.html" class="message">
                                                    <div class="message__actions_avatar">
                                                        <div class="avatar">
                                                            <img src="images/new/new/notification_head6.png" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- end /.actions -->
                                            ...
                                            <div class="cart_area">
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="images/new/new/capro1.jpg" alt="cart product thumbnail">
                                                        </div>
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <div class="cat">
                                                                <a href="#">
                                                                    <img src="images/new/new/catword.png" alt="">ورد پرس </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="images/new/new/capro2.jpg" alt="cart product thumbnail">
                                                        </div>
                            ...
                            <div class="author-author__info inline has_dropdown">
                                <div class="author__avatar">
                                    <img src="images/new/new/usr_avatar.png" alt="user avatar">
                ...
                <div class="col-lg-12">
                    <div class="testimonial-slider">
                        <div class="testimonial">
                            <div class="testimonial__about">
                                <div class="avatar v_middle">
                                    <img src="images/new/new/test1.jpg" alt="Testimonial Avatar">
                                </div>
                        ...
                        <div class="testimonial">
                            <div class="testimonial__about">
                                <div class="avatar v_middle">
                                    <img src="images/new/new/test2.jpg" alt="Testimonial Avatar">
                                </div>
                                <div class="name-designation v_middle">
                                    <h4 class="name">کاربر تست </h4>
                                    <span class="desig">طراح محصویل </span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="info-footer">
                            <div class="info__logo">
                                <img src="images/new/new/flogo.png" alt="footer logo">
                            </div>
