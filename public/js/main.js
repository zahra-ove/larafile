(function ($) {
    ...
    $('.testimonial-slider').slick({
        ...
        slidesToShow: 2,
        slidesToScroll: 1,
        nextArrow: '<span class="lnr lnr-chevron-left"></span>',
        prevArrow: '<span class="lnr lnr-chevron-right"></span>',
        responsive: [
            {
                breakpoint: 768,
                settings: {
